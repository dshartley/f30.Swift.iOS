...
/// A view class for a P1
public class P1: UIView, ProtocolP1 {
	
	// MARK: - Private Stored Properties
	
	fileprivate var controlManager:				P1ControlManager?

	
	// MARK: - Public Stored Properties
	
	public weak var delegate:					ProtocolP1Delegate?
	...
	// MARK: - Public Methods; ProtocolP1
	...
	fileprivate func setupControlManager() {
		...
		self.controlManager 			= P1ControlManager()
	...
	fileprivate func setupViewManager() {
		...
		let viewAccessStrategy: P1ViewAccessStrategy = P1ViewAccessStrategy()
		
		viewAccessStrategy.setup(contentImageView: self.contentImageView)
		
		// Setup the view manager
		self.controlManager!.viewManager = P1ViewManager(viewAccessStrategy: viewAccessStrategy)
	}
	
	fileprivate func setupContentView() {
		
		// Load xib
		Bundle.main.loadNibNamed("P1", owner: self, options: nil)
	...
	@IBAction func contentViewTapped(_ sender: Any) {
		...
		// Notify the delegate
		self.delegate?.p1(tapped: self.controlManager!.wrapper!, sender: self)

	}
	
}

// MARK: - Extension ProtocolP1ControlManagerDelegate

extension P1: ProtocolP1ControlManagerDelegate {
