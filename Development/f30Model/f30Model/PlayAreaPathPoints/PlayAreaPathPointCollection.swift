//
//  PlayAreaPathPointCollection.swift
//  f30Model
//
...
public class PlayAreaPathPointCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayAreaPathPoint = PlayAreaPathPoint(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayAreaPathPoint = self.getNewItem() as! PlayAreaPathPoint
