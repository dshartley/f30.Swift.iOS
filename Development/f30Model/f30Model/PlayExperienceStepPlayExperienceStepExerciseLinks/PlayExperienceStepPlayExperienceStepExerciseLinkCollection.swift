//
//  PlayExperienceStepPlayExperienceStepExerciseLinkCollection.swift
//  f30Model
//
...
/// Encapsulates a collection of PlayExperienceStepPlayExperienceStepExerciseLink items
public class PlayExperienceStepPlayExperienceStepExerciseLinkCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayExperienceStepPlayExperienceStepExerciseLink = PlayExperienceStepPlayExperienceStepExerciseLink(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayExperienceStepPlayExperienceStepExerciseLink = self.getNewItem() as! PlayExperienceStepPlayExperienceStepExerciseLink
