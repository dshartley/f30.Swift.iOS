//
//  PlayAreaTileDataAttributeDataWrapper.swift
//  f30Model
//
...
/// A wrapper for a PlayAreaTileDataAttributeDataWrapper model item
public class PlayAreaTileDataAttributeDataWrapper {
