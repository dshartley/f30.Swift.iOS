//
//  PlayChallengeObjectiveTypeContentDataWrapper.swift
//  f30Model
//
...
/// A wrapper for a PlayChallengeObjectiveTypeContentDataWrapper model item
public class PlayChallengeObjectiveTypeContentDataWrapper {
