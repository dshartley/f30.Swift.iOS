//
//  PlayChallengeObjectiveTypeCollection.swift
//  f30Model
//
...
public class PlayChallengeObjectiveTypeCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayChallengeObjectiveType = PlayChallengeObjectiveType(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayChallengeObjectiveType = self.getNewItem() as! PlayChallengeObjectiveType
