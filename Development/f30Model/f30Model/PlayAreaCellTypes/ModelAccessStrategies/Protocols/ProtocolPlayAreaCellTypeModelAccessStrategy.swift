//
//  ProtocolPlayAreaCellTypeModelAccessStrategy.swift
//  f30Model
//
...
/// Defines a class which provides a strategy for accessing the PlayAreaCellType model data
public protocol ProtocolPlayAreaCellTypeModelAccessStrategy {
