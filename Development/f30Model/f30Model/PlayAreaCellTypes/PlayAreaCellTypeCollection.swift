//
//  PlayAreaCellTypeCollection.swift
//  f30Model
//
...
/// Encapsulates a collection of PlayAreaCellType items
public class PlayAreaCellTypeCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayAreaCellType = PlayAreaCellType(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayAreaCellType = self.getNewItem() as! PlayAreaCellType
