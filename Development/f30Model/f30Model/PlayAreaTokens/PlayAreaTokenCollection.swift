...
/// Encapsulates a collection of PlayAreaToken items
public class PlayAreaTokenCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayAreaToken = PlayAreaToken(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayAreaToken = self.getNewItem() as! PlayAreaToken
