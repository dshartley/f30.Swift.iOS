//
//  ProtocolPlayAreaCellModelAccessStrategy.swift
//  f30Model
//
...
/// Defines a class which provides a strategy for accessing the PlayAreaCell model data
public protocol ProtocolPlayAreaCellModelAccessStrategy {
