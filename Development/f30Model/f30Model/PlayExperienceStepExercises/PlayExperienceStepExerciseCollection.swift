//
//  PlayExperienceStepExerciseCollection.swift
//  f30Model
//
...
/// Encapsulates a collection of PlayExperienceStepExercise items
public class PlayExperienceStepExerciseCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayExperienceStepExercise = PlayExperienceStepExercise(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayExperienceStepExercise = self.getNewItem() as! PlayExperienceStepExercise
