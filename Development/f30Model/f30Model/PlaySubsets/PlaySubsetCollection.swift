...
/// Encapsulates a collection of PlaySubset items
public class PlaySubsetCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlaySubset = PlaySubset(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlaySubset = self.getNewItem() as! PlaySubset
