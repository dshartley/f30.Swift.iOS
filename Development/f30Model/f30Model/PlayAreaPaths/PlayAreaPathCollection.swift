...
/// Encapsulates a collection of PlayAreaPath items
public class PlayAreaPathCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayAreaPath = PlayAreaPath(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayAreaPath = self.getNewItem() as! PlayAreaPath
