...
/// Encapsulates a collection of PlayMove items
public class PlayMoveCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayMove = PlayMove(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayMove = self.getNewItem() as! PlayMove
