...
/// Encapsulates a collection of PlayChallenge items
public class PlayChallengeCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayChallenge = PlayChallenge(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayChallenge = self.getNewItem() as! PlayChallenge
