//
//  PlayExperienceCollection.swift
//  f30Model
//
...
/// Encapsulates a collection of PlayExperience items
public class PlayExperienceCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayExperience = PlayExperience(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayExperience = self.getNewItem() as! PlayExperience
