...
/// Encapsulates a collection of PlayGameData items
public class PlayGameDataCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayGameData = PlayGameData(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayGameData = self.getNewItem() as! PlayGameData
