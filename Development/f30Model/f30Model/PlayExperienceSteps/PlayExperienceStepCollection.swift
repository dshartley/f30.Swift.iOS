//
//  PlayExperienceStepCollection.swift
//  f30Model
//
...
/// Encapsulates a collection of PlayExperienceStep items
public class PlayExperienceStepCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayExperienceStep = PlayExperienceStep(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayExperienceStep = self.getNewItem() as! PlayExperienceStep
