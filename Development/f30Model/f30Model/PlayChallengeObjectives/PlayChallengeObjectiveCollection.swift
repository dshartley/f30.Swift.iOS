//
//  PlayChallengeObjectiveCollection.swift
//  f30Model
//
...
public class PlayChallengeObjectiveCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayChallengeObjective = PlayChallengeObjective(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayChallengeObjective = self.getNewItem() as! PlayChallengeObjective
