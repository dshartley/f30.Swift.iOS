...
/// Encapsulates a collection of UserProfile items
public class UserProfileCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: UserProfile = UserProfile(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: UserProfile = self.getNewItem() as! UserProfile
