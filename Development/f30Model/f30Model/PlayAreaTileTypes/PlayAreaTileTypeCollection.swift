//
//  PlayAreaTileTypeCollection.swift
//  f30Model
//
...
/// Encapsulates a collection of PlayAreaTileType items
public class PlayAreaTileTypeCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayAreaTileType = PlayAreaTileType(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayAreaTileType = self.getNewItem() as! PlayAreaTileType
