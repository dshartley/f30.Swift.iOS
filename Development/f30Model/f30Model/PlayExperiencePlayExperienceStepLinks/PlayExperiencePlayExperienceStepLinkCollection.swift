//
//  PlayExperiencePlayExperienceStepLinkCollection.swift
//  f30Model
//
...
/// Encapsulates a collection of PlayExperiencePlayExperienceStepLink items
public class PlayExperiencePlayExperienceStepLinkCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayExperiencePlayExperienceStepLink = PlayExperiencePlayExperienceStepLink(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayExperiencePlayExperienceStepLink = self.getNewItem() as! PlayExperiencePlayExperienceStepLink
