//
//  PlayChallengeTypeOnCompleteDataWrapper.swift
//  f30Model
//
...
/// A wrapper for a PlayChallengeTypeOnCompleteDataWrapper model item
public class PlayChallengeTypeOnCompleteDataWrapper: OnCompleteDataWrapperBase {
