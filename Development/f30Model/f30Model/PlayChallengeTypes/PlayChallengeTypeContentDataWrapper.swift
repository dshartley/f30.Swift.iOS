//
//  PlayChallengeTypeContentDataWrapper.swift
//  f30Model
//
...
/// A wrapper for a PlayChallengeTypeContentDataWrapper model item
public class PlayChallengeTypeContentDataWrapper {
