//
//  PlayChallengeTypeCollection.swift
//  f30Model
//
...
/// Encapsulates a collection of PlayChallengeType items
public class PlayChallengeTypeCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlayChallengeType = PlayChallengeType(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlayChallengeType = self.getNewItem() as! PlayChallengeType
